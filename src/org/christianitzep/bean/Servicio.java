...
public class Servicio {
    ...
    public Servicio(int codigoServicio, Date fechaServicio, String tipoServicio, String horaServicio, String lugarServicio, String telefonoServicio, int codigoEmpresa) {
